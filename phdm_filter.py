...
# File Created: Thursday, 9th December 2021 4:20:55 pm                                                       #
# Author: Flávio Eler De Melo                                                                                #
# -----                                                                                                      #
# This package/module implements the Gaussian mixture PHD filter with labels as proposed in:                 #
#                                                                                                            #
# K. Panta, D. E. Clark and B. Vo, "Data Association and Track Management for the Gaussian Mixture           #      
# Probability Hypothesis Density Filter," IEEE Transactions on Aerospace and Electronic Systems,             # 
# vol. 45, no. 3, pp. 1003-1016, July 2009.                                                                  #
#                                                                                                            #
# BibTeX entry:                                                                                              #
# @ARTICLE{PHDM2009,                                                                                         #
#  author={K. Panta and D. E. Clark and B. Vo},                                                              #
#  journal={IEEE Transactions on Aerospace and Electronic Systems},                                          #
#  title={Data Association and Track Management for the                                                      #
...
#  pages={1003-1016}}                                                                                        # 
# -----                                                                                                      #
# Last Modified: Thursday, 9th December 2021 4:23:43 pm                                                      #
...
class PHDFilterWithMarks(object):
    ...
    def run(self, measurement_set, print_flag=False):
        ...
        for k in range(self.K):
            ...
            log_w_update = log_q_d + log_w_predict
            ...
            # Update cumulants
            mu_update = np.sum(w_update)
            var_update = mu_update
    ...
    def extract_estimates(self, w_update, m_update, l_update, mu_update, var_update, k, assoc_hist=None):
        ...
        N_k = int(round(min(mu_update, len(unique_labels))))
